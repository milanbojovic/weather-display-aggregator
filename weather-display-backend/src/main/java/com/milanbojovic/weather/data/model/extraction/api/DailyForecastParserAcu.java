...
import com.milanbojovic.weather.data.model.extraction.api.interfaces.DailyForecastParser;
...
public class DailyForecastParserAcu implements DailyForecastParser {
    private final DailyForecast dailyForecast;
    private final AppConfig appConfig;

    public DailyForecastParserAcu(String city, AppConfig appConfig) {
