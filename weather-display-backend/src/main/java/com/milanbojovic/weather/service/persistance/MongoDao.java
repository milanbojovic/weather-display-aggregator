...
public class MongoDao {
    ...
    public  void writeWeatherData(List<WeatherData> weatherData, String provider) {
        try (MongoClient client = MongoClients.create(clientSettings)) {
            ...
            MongoCollection<WeatherData> weatherDataCollection = db.getCollection(provider, WeatherData.class);
            weatherDataCollection.insertMany(weatherData);
        }
    }

    private String jsonFrom(WeatherData weatherData) throws JsonProcessingException {
    ...
    public WeatherData readWeatherData(String city, String collection) {
        ...
        try (MongoClient mongoClient = MongoClients.create(clientSettings)) {
            ...
            MongoCollection<WeatherData> collectionWeatherData = db.getCollection(collection, WeatherData.class);
